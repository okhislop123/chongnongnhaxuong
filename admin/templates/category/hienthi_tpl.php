...
<table class="table table-bordered table-hover">
	...
	<tbody>
		...
		<tr>
			<td>
				<?php if($items[$i]['id'] != 12102 && $items[$i]['id'] != 12148 && $items[$i]['id'] != 11130 && $items[$i]['id'] != 12612 && $items[$i]['id'] != 12631  ) { ?>
...
<input type="number" value="<?=$items[$i]['so_thu_tu']?>" class="a_stt" data-table="#_category" data-col="so_thu_tu" data-id="<?=$items[$i]['id']?>" />
    	...
    	<tr>
			...
			<td>
				...
				<?php if($child_items[$j]['id'] != 1202 && $child_items[$j]['id'] != 1235 && $child_items[$j]['id'] != 1210 && $child_items[$j]['id'] != 1211  ) { ?>
