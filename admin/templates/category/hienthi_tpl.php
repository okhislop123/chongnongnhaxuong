		...
		<table class="table table-bordered table-hover">
			...
			<tbody>
				...
				for ($i = 0; $i < $count; $i++) { ?>
					<tr>
						<td>
							<?php if ($items[$i]['id'] != 1288 && $items[$i]['id'] != 1291 && $items[$i]['id'] != 1296 && $items[$i]['id'] != 1309 && $items[$i]['id'] != 1300 && $items[$i]['id'] != 1297 && $items[$i]['id'] != 1301 && $items[$i]['id'] != 1130 && $items[$i]['id'] != 1302 && $items[$i]['id'] != 1304 && $items[$i]['id'] != 1305 && $items[$i]['id'] != 12631 && $items[$i]['id'] != 12631 && $items[$i]['id'] != 12631 && $items[$i]['id'] != 12631) { ?>
				...
				<input class="chk_box" type="checkbox" onclick="on_check(this,'#_category','is_top','<?= $items[$i]['id'] ?>')" <?php if ($items[$i]['is_top'] == 1) echo 'checked="checked"'; ?>>
						...
						<td>
							...
							<?php if ($items[$i]['id'] != 12012 && $items[$i]['id'] != 12148 && $items[$i]['id'] != 11130 && $items[$i]['id'] != 12621 && $items[$i]['id'] != 12631) { ?>
